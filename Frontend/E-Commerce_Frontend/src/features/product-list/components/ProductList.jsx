      ...
      <div>
        <div className="bg-white">
          <div>
            ...
            <MobileFilters mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleFilter={handleFilter} />
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {/* Section for Products and filters end */}
